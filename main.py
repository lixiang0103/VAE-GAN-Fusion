...
flags.DEFINE_integer("max_iters" , 100000, "the maxmization epoch")
flags.DEFINE_integer("latent_dim" , 100, "the dim of latent code")
...
flags.DEFINE_string("path", '../data/', "for example, '/home/jack/data/' is the directory of your celebA data")
...
if __name__ == "__main__":
    ...
    # return train_data_list and train_lab_list
